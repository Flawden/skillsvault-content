...
- результирующий вес представляется действующим через ЦТ;
- масса приспособления может менять общий ЦТ;
- свободная ориентация зависит от связей/контакта и не выводится только из рисунка.

Guard:

- это не capacity-selection формула.
...
- идеальный шарнир/вертлюг — модель связи;
...
- при лишних неизвестных реакциях распределение может зависеть от stiffness/жёсткости, зазоров, контакта и последовательности включения.
...
Общая механика/физика без rating:
